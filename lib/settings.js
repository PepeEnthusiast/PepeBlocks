...
exports.shared_pages = {
  ...
  "page_header": {
    ...
    "panels": {
      ...
      // halving_panel: a collection of settings that pertain to the halving panel which displays the next halving countdown timer
      "halving_panel": {
        // enabled: Enable/disable the halving panel (true/false)
        //          If set to false, the halving panel will be completely inaccessible
        "enabled": true,
        // display_order: Determine which order this panel is shown from 1-5
        //                1 = far left panel, 5 = far right panel
        //                The panel will be disabled with a value of 0
...
exports.richlist_page = {
  ...
  // show_current_balance: Determine whether to show the top 500 list of wallet addresses that currently have the most coins in a single wallet (true/false)
  "show_current_balance": true,
  // show_received_coins: Determine whether to show the top 500 list of wallet addresses that have the highest total number of coins received based on adding up all received transactions (true/false)
